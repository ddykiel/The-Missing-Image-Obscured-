...
def createGraph(rand_depth, rand_style, rand_artist_affinity, rand_ethan_hurts, rand_friend_judgment):
  ...
  storyGraph = nx.DiGraph()
  storyGraph.add_edge(section_1, section_1_you)
...
while run_loop:
  ...
  storyGraph = createGraph(rand_depth, rand_style, rand_artist_affinity, rand_ethan_hurts, rand_friend_judgment)

  run_num += 1

  story_tree = nx.dfs_tree(storyGraph)
